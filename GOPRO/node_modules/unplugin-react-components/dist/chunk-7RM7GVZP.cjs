...
function searchGlob(options) {
  ...
  const files = _fastglob2.default.sync(["**/**.tsx", "**/**.jsx"], {
    ignore: ["node_modules"],
    cwd: rootPath
  });
  const components = /* @__PURE__ */ new Set();
  for (const file of files) {
    const code = _fs2.default.readFileSync(_path.resolve.call(void 0, rootPath, file), { encoding: "utf-8" });
    const program = _parser.parse.call(void 0, code, {
      sourceType: "module",
      plugins: [
        "typescript",
        "jsx"
    ...
    _estreewalker.walk.call(void 0, program, {
      enter(nodes) {
...
function stringifyComponent(rootPath, component) {
  const related = `./${_path.relative.call(void 0, rootPath, component.path)}`;
...
async function generateDts(options) {
  ...
  _fs.writeFileSync.call(void 0, `${rootPath}/${filename}.d.ts`, `${dts}}`, { encoding: "utf-8" });
  return dts;
}
...
function createResolver(_options) {
  return async (options = {}) => {
    ...
    const pkgs = await _localpkg.importModule.call(void 0, _options.module);
...
var src_default = _unplugin.createUnplugin.call(void 0, (options = {}) => {
  ...
  return {
    ...
    async transform(code, id) {
      const context = {
        code: new (0, _magicstring2.default)(code),
        components: searchGlobResult,
...
exports.resolversType = resolversType; exports.getResolversResult = getResolversResult; exports.transform = transform; exports.searchGlob = searchGlob; exports.generateDts = generateDts; exports.createResolver = createResolver; exports.MuiResolver = MuiResolver; exports.AntdResolver = AntdResolver; exports.src_default = src_default;
